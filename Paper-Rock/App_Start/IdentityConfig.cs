...
namespace Paper_Rock
{
    ...
    public class PlayerManager : UserManager<Player>
    {
        ...
        {
            var manager = new PlayerManager(new UserStore<Player>(context.Get<DBContext>()));
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<Player>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
